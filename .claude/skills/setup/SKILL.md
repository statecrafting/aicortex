---
name: setup
description: "One-time contributor setup for aicortex: install spec-spine 0.11.0, the pinned Rust toolchain once rust-toolchain.toml exists, the optional cargo-deny, and verify the governed loop with make spine."
